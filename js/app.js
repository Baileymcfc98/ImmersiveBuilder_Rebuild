...
window.addEventListener("DOMContentLoaded", () => {
    ...
    badge.style.cssText = "position:fixed;right:10px;top:10px;background:#22aa22;color:#fff;padding:6px 10px;border-radius:4px;font:12px/1.2 system-ui;z-index:99999";
